...
description: Use when reviewing user-owned outbound text for AI-sounding patterns, voice fit, clarity, specificity, readability, or professional polish across PR descriptions, Slack drafts, Confluence pages, release notes, commit messages, docs, emails, code comments, and public copy. Triggers on "humanize this", "make this less AI-sounding", "flag AI tells", "AI pattern check", "does this sound like AI", "make this sound more like me", "clean up this draft", or "review this for voice". Do not use for standalone authorship verdicts, third-party accusations, detector evasion, plagiarism adjudication, academic-integrity enforcement, impersonating another person's voice, or wholesale content generation.
---
...
1. **Plan when needed.** Use `TodoWrite` for multi-file, batch, high-stakes, public, legal/compliance, or publication-bound reviews.
