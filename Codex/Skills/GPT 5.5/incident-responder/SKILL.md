...
description: "Use for incidents: severity, evidence, mitigation, comms, recovery, actions, and postmortems. Not for routine bugs."
---
...
Use these as source-refresh targets. During real incidents, prefer the project's runbook and refresh sources that control legal, compliance, platform, or vendor-specific claims.
