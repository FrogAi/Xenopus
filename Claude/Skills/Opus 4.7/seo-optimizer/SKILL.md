---
name: seo-optimizer
description: 'Use when auditing, recommending, or applying local repository SEO improvements for public or pre-release websites: technical SEO, indexability, robots.txt, sitemap.xml, canonical tags, hreflang, metadata, structured data, Core Web Vitals, mobile/rendering crawlability, redirects, broken links, Open Graph/Twitter cards, on-page SEO, thin/duplicate content, content gaps, keyword cannibalization, and orphan pages. Triggers on "SEO audit", "technical SEO check", "fix metadata", "structured data audit", "Core Web Vitals", "sitemap audit", "canonical check", "hreflang", "rich results", "broken links", or "crawlability". Do not use for paid ads, campaign analytics, copywriting-only requests, legal SEO compliance opinions, or search-spam tactics.'
---
...
1. **Plan the audit or fix.** Use `TodoWrite` for multi-page, production, high-risk, crawl, content, structured-data, or local-fix work. Track scope, evidence, source checks, findings/fixes, validation, and cleanup.
