...
description: "Use to search/read/summarize Slack messages, threads, channels, profiles, canvases, decisions, and drafts. Read-only."
---
...
Validate Slack findings by preserving message order, citing permalink or channel timestamp for each material claim, checking thread context before summarizing decisions, and reporting pagination, permission, retention, search-lag, deleted-message, and Slack Connect limits. Do not treat uncited memory or partial search results as complete evidence.
